...
#Script to extract sequences from a larger fasta file using a list of sequence names that you either want to include or exclude from your final result.
#Output is in STOUT so use '>' to redirect it to a new file.
